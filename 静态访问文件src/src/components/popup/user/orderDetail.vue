<template>
  <div class="order-detail">
    <div class="top" :style="{backgroundImage: `url(${require('../../../static/data/imgs/'+order.hotel_info[0].imgs[0])})`}">
    ...
    <div class="order-information" style="padding-top: 0">
      ...
      <div class="order-house">
        <img :src="require('../../../static/data/imgs/' + order.hotel_info[0].imgs[0])" alt="">
...
<script>
  ...
  import oneOrder from '../../../static/data/one_order'
