<template>
  <div class="facilityHouse">
    ...
    <div class="titleInput new-box">
      <p>周边美食</p>
      <div class="food-img">
        <img v-for="(item, index) in checkedImgList" :key="index" :src="require('../../../static/data/imgs/'+item)" alt="服务器错误">
      </div>
...
<script>
  ...
  import around from '../../../static/data/around'
